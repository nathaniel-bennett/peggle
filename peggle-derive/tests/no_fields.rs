...
pass!(
    simple_kleenestar_multi_match,
    TestEmptyNamed03,
    "aaaaaaaaaaa"
);
fail!(
    simple_kleenestar_multi_nomatch,
    TestEmptyNamed03,
    "aaaaaaaaaaab"
);
...
pass!(
    double_kleenestar_zero_multi_match,
    TestEmptyNamed04,
    "bbbbbbbbbbbc"
);
pass!(
    double_kleenestar_one_multi_match,
    TestEmptyNamed04,
    "abbbbbbbbbbbc"
);
pass!(
    double_kleenestar_multi_multi_match,
    TestEmptyNamed04,
    "aaaaaaaaaaabbbbbbbbbbbc"
);
pass!(
    double_kleenestar_multi_one_match,
    TestEmptyNamed04,
    "aaaaaaaaaaabc"
);
pass!(
    double_kleenestar_multi_zero_match,
    TestEmptyNamed04,
    "aaaaaaaaaaabc"
);
fail!(
    double_kleenestar_multi_multi_nomatch,
    TestEmptyNamed04,
    "aaaaaaaaaaabbbbbbbb"
);
...
pass!(
    double_kleenestar_greedy_match,
    TestEmptyNamed05,
    "bbbbbbbbbab"
);
fail!(
    double_kleenestar_greedy_nomatch,
    TestEmptyNamed05,
    "aaaaaaaaaab"
);
...
pass!(
    range_multidigit_samevalue_match,
    TestEmptyNamed11,
    "aaaaaaaaaaab"
);
fail!(
    range_multidigit_nomatch_low,
    TestEmptyNamed11,
    "aaaaaaaaaab"
);
fail!(
    range_multidigit_nomatch_high,
    TestEmptyNamed11,
    "aaaaaaaaaaaab"
);
...
fail!(
    range_singlevalue_nomatch_low,
    TestEmptyNamed12,
    "aaaaaaaaaaaab"
);
fail!(
    range_singlevalue_nomatch_high,
    TestEmptyNamed12,
    "aaaaaaaaaaaaaab"
);
